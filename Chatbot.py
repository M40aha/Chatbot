...
class VoiceChatbot:
    def __init__(self):
        self.cohere = cohere.Client("ro5YlUUDmQKMsNgy6lMJM3UREEGsG6dzGqa50Dtv")  # Replace with your actual Cohere API key
    ...
    def think(self, text):
        response = self.cohere.chat(model="command-r7b-arabic-02-2025",message=text,temperature=0.7,max_tokens=200, preamble="جاوب بلهجة سعودية فقط، جاوب بشكل مختصر، اسمك هو المساعد الذكي وقد صممتك مها العمري  ")
